...
public interface WishlistItemRepository extends JpaRepository<WishlistItem, Long> {
    ...
    public WishlistItem isWishlistItemExist(@Param("wishlist") Wishlist wishlist, @Param("product") Product product, @Param("size")String size, @Param("userId")Long userId);
